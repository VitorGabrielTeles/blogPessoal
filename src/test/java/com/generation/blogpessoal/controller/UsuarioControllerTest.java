...
public class UsuarioControllerTest {
	...
	void start() {
		...
		usuarioService.cadastrarUsuario(new Usuario(null,"root","root@root.com", "root123", "*"));
	}
	
	@Test
	@DisplayName("Cadastrar Usuario")
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(null, "vitor", "vitor@gmail.com", "12345678", "*") );
